...
protocol CustomizedVideoRenderDelegate {
    func renderer(_ renderer: CustomizedVideoRender, didReceiveFrame: OTVideoFrame)
}

class CustomizedVideoRender: UIView {
    ...
    override init(frame: CGRect) {
        ...
        NotificationCenter.default
            .addObserver(self, selector: #selector(CustomizedVideoRender.willResignActive),
                         name: NSNotification.Name.UIApplicationWillResignActive, object: nil)
        NotificationCenter.default
            .addObserver(self, selector: #selector(CustomizedVideoRender.didBecomeActive),
...
extension CustomizedVideoRender: GLKViewDelegate {
...
extension CustomizedVideoRender: OTVideoRender {
...
class DisplayLinkProxy {
    var renderer: CustomizedVideoRender
    var view: GLKView
    
    init(glkView: GLKView, videoRender: CustomizedVideoRender) {
